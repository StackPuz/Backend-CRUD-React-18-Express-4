            ...
            <table className="table table-sm table-striped table-hover">
              ...
              <tbody>
                ...
                <tr key={index}>
                  ...
                  <td className="d-none d-md-table-cell text-center">{ product.image && <a href={`http://localhost:8000/uploads/products/${product.image}`} target="_blank" rel="noreferrer" title={`${product.image}`}><img className="img-list" src={`http://localhost:8000/uploads/products/${product.image}`} /></a> }</td>
                  <td>{product.name}</td>
